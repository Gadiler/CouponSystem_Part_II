...
public class Bootstrap implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Coupon c1 = Coupon.builder().id(1).companyId(2).category(Category.ELECTRICITY).title("Electricity").description("Electricity products discount").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(500.0).image("/assets/images/1+1.png").build();
        Coupon c2 = Coupon.builder().id(2).companyId(1).category(Category.FOOD).title("Drinks").description("Drinks discount").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(5000.0).image("/assets/images/1+1.png").build();
        Coupon c3 = Coupon.builder().id(3).companyId(4).category(Category.FOOD).title("Drinks & Chill").description("Discount on any product of Nestle").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(50.0).image("/assets/images/1+1.png").build();
        Coupon c4 = Coupon.builder().id(4).companyId(7).category(Category.VACATION).title("Vacation").description("Vacation discount").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(180.0).image("/assets/images/1+1.png").build();
        Coupon c5 = Coupon.builder().id(5).companyId(5).category(Category.RESTAURANT).title("Food").description("Food discount").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(150.0).image("/assets/images/1+1.png").build();
        Coupon c6 = Coupon.builder().id(6).companyId(3).category(Category.ELECTRICITY).title("Electricity").description("Electricity products discount").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(2500.0).image("/assets/images/1+1.png").build();
        Coupon c7 = Coupon.builder().id(7).companyId(10).category(Category.FOOD).title("Drinks for free").description("Drinks discount").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(50.0).image("/assets/images/1+1.png").build();
        Coupon c8 = Coupon.builder().id(8).companyId(9).category(Category.FOOD).title("Drinks on the house").description("Discount on any product of Nestle").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(50.0).image("/assets/images/1+1.png").build();
        Coupon c9 = Coupon.builder().id(9).companyId(8).category(Category.VACATION).title("Vacation at the most beautiful place").description("Vacation discount").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(1850.0).image("/assets/images/1+1.png").build();
        Coupon c10 = Coupon.builder().id(10).companyId(10).category(Category.RESTAURANT).title("Food 1+1").description("Food discount").startDate(DateUtils.getCurrentDate()).endDate(DateUtils.getDatePlusMonth()).amount(10).price(1150.0).image("/assets/images/1+1.png").build();
        /*Expired date coupon*/
